      ...
      <article className="glass-card rounded-2xl overflow-hidden flex flex-col h-full bg-card">
        ...
        <div className="p-6 flex flex-col flex-grow">
          <div className="flex items-center space-x-4 text-xs text-muted-foreground mb-3 font-medium">
            <span className="flex items-center bg-secondary/50 px-2 py-1 rounded-full"><Clock className="w-3 h-3 mr-1" /> {dateStr}</span>
            <span className="flex items-center"><User className="w-3 h-3 mr-1" /> {post.author?.name || "Anonymous"}</span>
          </div>
