...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(errorMsg);
      console.error("Login Error Payload:", { email, password });
      console.error(err);
    } finally {
      setIsLoading(false);
    }
    ...
    <div className="min-h-[80vh] flex items-center justify-center -mt-10 px-4">
      <div className="w-full max-w-md animate-fade-in relative z-10">
        <div className="glass-card p-8 md:p-10 rounded-3xl relative overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 w-32 h-32 bg-accent/20 blur-3xl rounded-full -translate-x-1/2 translate-y-1/2" />
